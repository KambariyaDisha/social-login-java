...
import com.example.payment.gateway.exeption.OAuth2AuthenticationProcessingException;
...
import com.example.payment.gateway.repository.RoleRepository;
import com.example.payment.gateway.repository.UserRepository;
import com.example.payment.gateway.reposnse.LocalUser;
import com.example.payment.gateway.request.SignUpRequest;
import com.example.payment.gateway.request.SocialProvider;
import com.example.payment.gateway.service.oath2.user.OAuth2UserInfo;
import com.example.payment.gateway.service.oath2.user.OAuth2UserInfoFactory;
