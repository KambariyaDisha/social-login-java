...
import com.example.payment.gateway.config.CurrentUser;
...
import com.example.payment.gateway.reposnse.ApiResponse;
import com.example.payment.gateway.reposnse.JwtAuthenticationResponse;
import com.example.payment.gateway.reposnse.LocalUser;
import com.example.payment.gateway.reposnse.SignUpResponse;
import com.example.payment.gateway.request.LoginRequest;
import com.example.payment.gateway.request.SignUpRequest;
import com.example.payment.gateway.service.UserService;
import com.example.payment.gateway.service.jwt.TokenProvider;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(new JwtAuthenticationResponse(jwt, authenticated,
