...
import com.example.payment.gateway.config.RazorPayClientConfig;
import com.example.payment.gateway.model.User;
import com.example.payment.gateway.reposnse.ApiResponse;
import com.example.payment.gateway.reposnse.OrderResponse;
import com.example.payment.gateway.reposnse.PaymentResponse;
import com.example.payment.gateway.request.OrderRequest;
import com.example.payment.gateway.service.OrderService;
...
public class OrderController {
	...
	public ResponseEntity<?> createOrder(@RequestBody OrderRequest orderRequest,User user) {
		...
		try {
			...
			orderService.saveOrder(razorPay.getRazorpayOrderId(), user.getId());
