...
import com.example.payment.gateway.service.jwt.TokenAuthenticationFilter;
import com.example.payment.gateway.service.oath2.CustomOAuth2UserService;
import com.example.payment.gateway.service.oath2.CustomOidcUserService;
import com.example.payment.gateway.service.oath2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.example.payment.gateway.service.oath2.OAuth2AccessTokenResponseConverterWithDefaults;
import com.example.payment.gateway.service.oath2.OAuth2AuthenticationFailureHandler;
import com.example.payment.gateway.service.oath2.OAuth2AuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().csrf()
				...
				.antMatchers("/", "/error", "/api/all", "/api/auth/**", "/oauth2/**").permitAll().anyRequest()
